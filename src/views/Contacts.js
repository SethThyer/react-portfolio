...
import Skeleton from '../images/Projects/Skeleton.png'
    ...
    return (
      <div className="contacts">
        ...
        <div className="center-children bg-color-primary">
          <div className="z-1 contactBox text">
              Let's work together on something amazing!<br />
            <div className="mail-text">
              <a href="mailto: SethThyer.Business@gmail.com?Subject=Want's To Chat!" className="btn-color-anim">Send me an Email!</a>
            </div>
              <div className="img-circle-wrap">
                ...
                <div className="img-circle"><img alt="a render of a skeleton I made" src={Skeleton} /></div>
